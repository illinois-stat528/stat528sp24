...
We will consider an exponential family with log likelihood
$$
...
\begin{thm}
For a full exponential family with convex support $C$ and observed value of the canonical statistic $y \in C$, the following are equivalent:
\begin{itemize}
...
$$
Then we have that the LCM is the OM conditioned on the event
$$
